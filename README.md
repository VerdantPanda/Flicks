# Flicks
App that displays movie information from Movie API.
...
Initially I faced challenges with understanding the how the Adapters linked with the data, however with the help of my peers I was able to get a better understanding and complete my app.
